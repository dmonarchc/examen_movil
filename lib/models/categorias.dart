...
class ListadoCategory {
  ...
  factory ListadoCategory.fromJson(String str) =>
      ListadoCategory.fromMap(json.decode(str));

  String toJson() => json.encode(toMap());

  factory ListadoCategory.fromMap(Map<String, dynamic> json) => ListadoCategory(
